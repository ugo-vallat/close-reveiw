...
/**
 * @brief Initialise la structure History Info et ouvre ou creer le fichier path_fichier_historique
 * @param path_fichier_historique fichier dans le quelle l'historique sera sauvegarder
 * @param nom_conversation nom de la conversation a sauvegarder (id de la personne avec qui on a la discution)
 * @return HistoryInfo*
 ...
 * @param message struture message a historiser
 * @param info structure qui contient les information pour l'historisation
...
/**
 * @brief lit les dernier nb_messasse le message dans l'historique dont les information sont donner par info
 ...
 * @param[out] l liste generique vide qui contiendra les message
